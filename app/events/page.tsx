          ...
          <div className="absolute top-0 left-0 w-64 h-screen bg-white shadow-lg flex flex-col">
            ...
            <nav className="flex-1 overflow-y-auto">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium border-l-4 border-transparent text-gray-600 hover:bg-gray-50 transition-colors border-t border-gray-200 mt-auto"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
